...
const orderController = require("../controllers/orderGRNController");
const {
...
router.post("/:orderCode/sync-busy", orderController.syncOrderToBusy);
...
router.get(
  "/partner/:partnerCode",
  validatePagination,
  orderController.getOrdersByPartner,
);
